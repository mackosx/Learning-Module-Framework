 ...
 */
function learningmodule_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'learningmodule_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.learningmodule-front-page) .entry-title,
...
.colors-custom .learningmodule-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.learningmodule-front-page .panel-content .recent-posts article,
...
.colors-custom.learningmodule-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'learningmodule_custom_colors_css', $css, $hue, $saturation );
}
